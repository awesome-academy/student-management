<?php
    return [
        ...
        'registration_name_max' => 'The registration name is not more than 100 characters',
        'max_credit_greater_than_min_credit' => 'The maximum number of credits cannot be less than the minimum',
        'generation_required' => 'You must select at least 1 generation',
        'time_finish_after_or_equal_time_begin' => 'The end time must not be less than the start time',
        'coincide_time' => 'Time coincides with another registration',
        'semester_create' => 'Thêm kỳ học mới',
        'begin_date' => 'Begin date',
        'finish_date' => 'Finish date',
        'finish_date_after_begin_date' => 'The finish date cannot be after the begin date',
        'coincide_name' => 'Name has already been taken!',
